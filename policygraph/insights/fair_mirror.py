...
# FY2024-25 rows have no voluntary counts: the CDI series ends in 2023 and the share is null there.
SQL = """
...
FROM fair LEFT JOIN nr USING (zip, y) JOIN entities e ON e.entity_id = zip
"""
